...
/* Exported types ------------------------------------------------------------*/
#define TIMEOUT_BURLA       500 // "Burla" remains beeping (Armis HC) while signal is LOW
...
typedef enum
{
	...
	_e_Timing_MotorClose,

	_e_Timing_Balance,

	_e_Timing_Encoder_MoveCheck,

	_e_Timing_Burla,

	_e_Timing_Solenoid_Mt1,
	_e_Timing_Solenoid_Mt2,
