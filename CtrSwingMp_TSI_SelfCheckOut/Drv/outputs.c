...
#define LOCK_PERCENT_MIN			1//3
#define LOCK_PERCENT_MAX			100//50
...
//				sOutLock[i].rampSpeed = LOCK_SPEED_RAMP_UP;
//
//				if( sOutLock[i].dutySys < LOCK_PERCENT_MAX )
//					sOutLock[i].dutySys++;
//				else
//				{
...
{
	sOutLock[_e_OutLock_Pri].stateSys = _e_LockState_Off;
	sOutLock[_e_OutLock_Sec].stateSys = _e_LockState_Off;
