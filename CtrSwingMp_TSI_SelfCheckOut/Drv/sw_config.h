...
#define SWCFG_BUZZER	                1
 ...
 #define SW_MOTOR_QTY                   SW_MOTOR_UNIT //SW_MOTOR_DUAL

 #define SW_SENSOR_MODE_NORMAL          0
 #define SW_SENSOR_MODE_GIGA            1
 #define SW_SENSOR_MODE_COMPLETO        2
 #define SW_SENSOR_MODE                 SW_SENSOR_MODE_NORMAL //SW_SENSOR_MODE_GIGA
 ...
 #define SW_OPERATION_METALIC_BARRIER   3                            // LBM - 10/02/2024: Utilizada no Atacadão (código: 37.707.096.0)
 #define SW_OPERATION_BARRIER           SW_OPERATION_METALIC_BARRIER //SW_OPERATION_SMALL_BARRIER // SW_OPERATION_METALIC_BARRIER

 #define SW_TRICK_MOTOR_DISABLE         0
 #define SW_TRICK_MOTOR_ENABLE          1
 #define SW_TRICK_MODE                  SW_TRICK_MOTOR_ENABLE // LBM - 05/11/2024: Usado para o teste da produção

#define SW_OPERATION_CUSTOM_TENDA       0 // LBM - 14/10/2024: POC TENDA
#define SW_OPERATION_PADRAO             1
#define SW_OPERATION_CUSTOM_MODE        SW_OPERATION_PADRAO //SW_OPERATION_CUSTOM_TENDA
...
#else
	#if(SW_OPERATION_BARRIER == SW_OPERATION_BIG_BARRIER)
...
// LBM - 24/02/2025: Alteração do ângulo de tolerância para 1. Isso foi feito pois reclamaram que a bandeira fica ligeiramente torta em posição de IDLE
#define ENC_MOVE_ANG_TOL		1 //3

#if(SW_OPERATION_BARRIER == SW_OPERATION_SMALL_BARRIER)
	#define POSITION_ANGPER_TOL		2//1.5//2 // 1 - Swing gabinete grande
#elif( (SW_OPERATION_BARRIER == SW_OPERATION_MEDIUM_BARRIER)||(SW_OPERATION_BARRIER == SW_OPERATION_BIG_BARRIER)||(SW_OPERATION_BARRIER == SW_OPERATION_METALIC_BARRIER) )
