...
#define SOLENOID_LOCK_MT1_ON()  _pin_set_h(GPIO_MT1_Lock1_Port, GPIO_MT1_Lock1_Pin)
#define SOLENOID_LOCK_MT1_OFF() _pin_set_l(GPIO_MT1_Lock1_Port, GPIO_MT1_Lock1_Pin)

#define SOLENOID_LOCK_MT2_ON()  _pin_set_h(GPIO_MT2_Lock1_Port, GPIO_MT2_Lock1_Pin)
#define SOLENOID_LOCK_MT2_OFF() _pin_set_l(GPIO_MT2_Lock1_Port, GPIO_MT2_Lock1_Pin)
...
void Clear_ActionRequest(tStpMtNum stpMtNum)
{
	sMtCtrl[stpMtNum].ActionRequest = false;
}
